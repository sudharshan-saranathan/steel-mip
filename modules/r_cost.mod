...
s.t. cost_ngdri_def{t in T}:
    n5_capex_ng[t]    * ngdri_output[t] / (1 - n7_phi_eaf)
...
# Removed: redundant duplicate definition of cost_ccs (identical to
# cost_captured_co2 above, since total_ccs = ccs_bf + ccs_cdri + ccs_ngdri).
