# NG availability scenario: GEOPOLITICAL SHOCK  (= "Shock case" profile from parameters.mod)
# Mid-2030s supply dip then recovery. Overrides n5_ng_cap[t] for all t in T.
