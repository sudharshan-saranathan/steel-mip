...
# This is a stale, pre-Fix-2/Fix-3 copy of the additional constraints.
# The canonical, maintained version is  modules/t_additional_constraints.mod
# (included by both main.mod and template.mod). This file still references the
# removed fraction variables (fc_bf/fc_cdri/fc_ngdri, and the f_cdri=0.8 init)
# and will ERROR if included against the current variables.mod. Kept only for
# historical reference. See MIP_gap_investigation.md (Fix 2, Fix 3).
# =====================================================================
# -----------------------------------
#        Initialization
# -----------------------------------
