...
# Coal DRI
var coaldri_output{T}           >= 0;  # X[46] (primary decision; route split; crude-steel basis, mip-v3)
...
# NG DRI
var ngdri_output{T}             >= 0;  # X[53] (primary decision; route split; crude-steel basis, mip-v3)
